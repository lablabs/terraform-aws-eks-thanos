...
| <a name="input_bucketweb_irsa_role_name"></a> [bucketweb\_irsa\_role\_name](#input\_bucketweb\_irsa\_role\_name) | IRSA role name for the Thanos Bucket Web. | `string` |
...
| <a name="input_compactor_irsa_assume_role_enabled"></a> [compactor\_irsa\_assume\_role\_enabled](#input\_compactor\_irsa\_assume\_role\_enabled) | Whether IRSA for the Thanos Compactor is allowed to assume role defined by `compactor_irsa_assume_role_arn`. Mutually exclusive with `compactor_irsa_policy_enabled`. | `bool` |
...
| <a name="input_compactor_irsa_role_name"></a> [compactor\_irsa\_role\_name](#input\_compactor\_irsa\_role\_name) | IRSA role name for the Thanos Compactor. | `string` |
...
| <a name="input_query_irsa_role_name"></a> [query\_irsa\_role\_name](#input\_query\_irsa\_role\_name) | IRSA role name for the Thanos query. | `string` |
...
| <a name="input_queryfrontend_irsa_role_name"></a> [queryfrontend\_irsa\_role\_name](#input\_queryfrontend\_irsa\_role\_name) | IRSA role name for the Thanos Query Frontend. | `string` |
...
| <a name="input_receive_enabled"></a> [receive\_enabled](#input\_receive\_enabled) | Set to true to enable Thanos Receive component | `bool` |
...
| <a name="input_receive_irsa_role_name"></a> [receive\_irsa\_role\_name](#input\_receive\_irsa\_role\_name) | IRSA role name for the Thanos Receive. | `string` |
...
| <a name="input_receivedistributor_irsa_role_name"></a> [receivedistributor\_irsa\_role\_name](#input\_receivedistributor\_irsa\_role\_name) | IRSA role name for the Thanos Receive Distributor. | `string` |
...
| <a name="input_ruler_irsa_assume_role_enabled"></a> [ruler\_irsa\_assume\_role\_enabled](#input\_ruler\_irsa\_assume\_role\_enabled) | Whether IRSA for the Thanos Ruler is allowed to assume role defined by `ruler_irsa_assume_role_arn`. Mutually exclusive with `ruler_irsa_policy_enabled`. | `bool` |
...
| <a name="input_ruler_irsa_role_name"></a> [ruler\_irsa\_role\_name](#input\_ruler\_irsa\_role\_name) | IRSA role name for the Thanos Ruler. | `string` |
...
| <a name="input_storegateway_irsa_role_name"></a> [storegateway\_irsa\_role\_name](#input\_storegateway\_irsa\_role\_name) | IRSA role name for the Thanos Store Gateway. | `string` |
